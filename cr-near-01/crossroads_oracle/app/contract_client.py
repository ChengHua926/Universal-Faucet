...
def create_contract(w3: Web3, address: str):
    return w3.eth.contract(
        ...
        abi=CROSSROADS_HEADER_ORACLE_ABI,
    )


def encode_registration_calldata(
    contract: Any,
    action: str,
    signer: str,
    commitment: str,
    ...
    if action == "register":
        fn = contract.functions.registerHeaderSigner(
            normalize_address(signer), commitment
        )
    elif action == "rotate":
